...
IF(UNIX)
  ...
  SET(G2O_LIBRARIES ${G2O_CORE_LIB} ${G2O_STUFF_LIB} ${G2O_TYPES_SLAM2D_LIB} ${G2O_TYPES_SLAM3D_LIB} ${G2O_SOLVER_PCG_LIB} ${G2O_SOLVER_CSPARSE_LIB})
  IF(G2O_CSPARSE_EXTENSION_LIB)
    LIST(APPEND G2O_LIBRARIES ${G2O_CSPARSE_EXTENSION_LIB})
  ENDIF()
