 ...
 */
    ...
    public:
         ...
         * @return \c true if planning was successful, \c false otherwise
         */
        virtual bool plan(const Pose& start, const Pose& goal, const Twist* start_vel = NULL, bool free_goal_vel=false);
         ...
         */
        virtual bool getVelocityCommand(float& vx, float& vy, float& omega, int look_ahead_poses) const;
...
//                                          double circumscribed_radius=0.0, int look_ahead_idx=-1);
    ...
    public:
        ...
        //bool plan(const std::vector<PoseStamped> &initial_plan, const Twist *start_vel, bool free_goal_vel);
    };
